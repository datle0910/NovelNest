      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0 group">
            <div className="w-[44px] h-[44px] bg-gradient-to-br from-brand-600 to-purple-600 rounded-xl flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-all shadow-md shadow-brand-500/20">
